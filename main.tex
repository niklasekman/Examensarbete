...
\begin{figure}[H]
    \centering
    \includegraphics[page=1,scale=.5, trim={550 350 100 200},clip]{Motedis Profile 40x40L I-Type slot 8 v1 Drawing v3} % left,bottom,right,top
...
Med insättning av uttrycket för töjning (ekv. \ref{eqn:tojning2}) i uttrycket för givarfaktorn (ekv. \ref{eqn:gauge_factor}), ytterligare insättning av spänningen från ekv. \ref{eqn:spanning} och utbrytning av den relativa resistansen fås ekvation \ref{eqn:rel_res} nedan.
