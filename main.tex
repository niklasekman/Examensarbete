...
\begin{figure}[H]
    \centering
    \includegraphics[scale=.25]{kalibreringsjigg.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=.25]{mätrigg.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=1]{Measured values and magnitude.pdf}
...
\textbf{Vinkel} & \textbf{Massa {[}g{]}} & \textbf{Mätvärde R-L} & \textbf{Mätvärde F-B} \\ \hline
